...
public interface I_Const_Extended extends I_Const {
    ...
    Book book8 = new Book("Архипелаг ГУЛАГ", "Александр Солженицын");
    ...
    Book book13 = new Book("Раковый корпус", "Александр Солженицын");
    Book book14 = new Book("Золотой телёнок", "Илья Ильф и Евгений Петров");
    Book book15 = new Book("Один день Ивана Денисовича", "Александр Солженицын");
